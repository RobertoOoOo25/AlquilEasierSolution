...
Deudas^ AlquilEasierService::Service::ConsultaDeudaByID(int deudaID)
{
    return Persistance::ConsultaDeudaByID(deudaID);
}
...
// INQUILINO
int AlquilEasierService::Service::AddInquilino(Inquilino^ inquilino)
{
    Persistance::AddInquilino(inquilino);
    return inquilino->DepAsignado;
}

int AlquilEasierService::Service::ModifyInquilino(Inquilino^ inquilino)
{
    return Persistance::ModifyInquilino(inquilino);
}

int AlquilEasierService::Service::DeleteInquilino(int numDep)
{
    return Persistance::DeleteInquilino(numDep);
}

List<Inquilino^>^ AlquilEasierService::Service::ConsultaInquilino()
{
    return Persistance::ConsultaInquilino();
}

Inquilino^ AlquilEasierService::Service::ConsultaInquilinoByNumDep(int numDep)
{
    return Persistance::ConsultaInquilinoByNumDep(numDep);
}
// FIN INQUILINO
...
/*List<Alarma^>^ AlquilEasierService::Service::QuearyAllAlarmaByDate(DateTime^ date)
{
    return Persistance::QuearyAllAlarmaByDate(date);
}*/
...
int AlquilEasierService::Service::ModifyPersonal(Personal^ personal)
{
    return Persistance::ModifyPersonal(personal);
}

int AlquilEasierService::Service::DeletePersonal(int personalID)
{
    return Persistance::DeletePersonal(personalID);
}

List<Personal^>^ AlquilEasierService::Service::ConsultaPersonal()
{
    return Persistance::ConsultaPersonal();
}

Personal^ AlquilEasierService::Service::ConsultaPersonalByID(int personalID)
{
